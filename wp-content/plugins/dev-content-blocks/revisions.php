...
class dc_dcb_WP_Post_Meta_Revisioning {
...
$wp_Post_Meta_Revisioning = new dc_dcb_WP_Post_Meta_Revisioning;

function dc_dcb_add_meta_keys_to_revision( $keys ) {
	$keys[] = 'dc_dcb_html';
	$keys[] = 'dc_dcb_css';
	$keys[] = 'dc_dcb_js';
	return $keys;
}
add_filter( 'wp_post_revision_meta_keys', 'dc_dcb_add_meta_keys_to_revision', 10, 2 );