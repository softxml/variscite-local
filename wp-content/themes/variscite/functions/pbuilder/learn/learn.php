...
if( ! class_exists( 'SiteOrigin_Learn_Dialog' ) ) {
	...
	class SiteOrigin_Learn_Dialog {
		...
		public function admin_footer() {
			...
			include PBUILDER_FULL . '/learn/tpl/dialog.php';
		}
		
		public function enqueue_scripts() {
			wp_enqueue_script( 'siteorigin-learn', PBUILDER_BASE . '/learn/js/learn' . ( WP_DEBUG ? '' : '.min' ) . '.js', array( 'jquery' ), false, true );
			wp_enqueue_style( 'siteorigin-learn', PBUILDER_BASE . '/learn/css/learn.css', array() );
		}
	}
