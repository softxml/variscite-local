...
define( 'PBUILDER_FULL', THEME_PATH.'/functions/pbuilder' );
define( 'PBUILDER_BASE', BASE_URL.'/functions/pbuilder' );
...
require_once PBUILDER_FULL . '/inc/functions.php';
	...
	function __construct() {
		...
		if ( is_admin() ) {
			...
			if( ! class_exists( 'SiteOrigin_Learn_Dialog' ) ) {
				include PBUILDER_FULL . '/learn/learn.php';
			}
		}
		...
		if( siteorigin_panels_setting( 'bundled-widgets' ) && ! function_exists( 'origin_widgets_init' ) ) {
			require_once PBUILDER_FULL . '/widgets/widgets.php';
		}
