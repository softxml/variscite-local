...
class SiteOrigin_Panels_Admin {
	...
	function render_meta_boxes( $post ) {
		...
		include PBUILDER_FULL . '/tpl/metabox-panels.php';
	}
	...
	function help_tab_content() {
		include PBUILDER_FULL . '/inc/tpl/help.php';
	}
	...
	function js_templates() {
		include PBUILDER_FULL . '/tpl/js-templates.php';
	}
	...
	function action_live_editor_preview() {
		...
		include PBUILDER_FULL . '/tpl/live-editor-preview.php';
